namespace NumericArrays.Virtual.Mathematics {
    ...
    public class AdditionArray<TType> : VirtualSourceArray<TType>
        ...
        public AdditionArray(INumericArray<TType> leftArray, INumericArray rightArray) :
        ...
        public override INumericArray<TType> Clone() => new AdditionArray<TType>(sourceArray, rightArray);
        #endregion
        #endregion
    }
}