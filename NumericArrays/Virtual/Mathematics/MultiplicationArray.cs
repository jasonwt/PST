namespace NumericArrays.Virtual.Mathematics {
    ...
    public class MultiplicationArray<TType> : VirtualSourceArray<TType>
        ...
        public MultiplicationArray(INumericArray<TType> leftArray, INumericArray rightArray) :
        ...
        public override INumericArray<TType> Clone() => new MultiplicationArray<TType>(sourceArray, rightArray);
        #endregion
        #endregion
    }
}