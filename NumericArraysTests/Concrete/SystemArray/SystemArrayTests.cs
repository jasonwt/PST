namespace NumericArrays.Concrete.SystemArray.Tests {
    ...
    [TestClass()]
    public class SystemArrayConstructTests {
        protected INumericArray<T> CreateArray<T>(int[] shape, ValueType[]? values = null)
        ...
        protected INumericArray<T> CreateArray<T>(int[] shape, ValueType value)
            where T: struct, IConvertible {
